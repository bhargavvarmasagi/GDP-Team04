...
Requirement Gathering:- (09/04/2024) <br>
...
Researched Security Measures for User Data Protection: (09/11/2024)<br>
...
Looked into Real-Time GPS Tracking for Delivery Drivers:- (09/16/2024)<br>
...
Explored Secure Payment Processing Options:- (09/16/2024)<br>
...
Proposed List of Prototypes for Grocery Delivery App:- (09/18/2024)<br>
...
Updated the Use cases wiki page by adding the new use case:- (09/20/2024)<br>
...
Looked into some of the requirements and modified in the Iteration 1 document:- (09/23/2024)<br>
...
I reviewed several requirements outlined in the Iteration 1 document that SYSTEM MAY and modified them:- (09/23/2024)<br>
...
Made improvements to the functional requirements in the Iteration 1 document:- (09/23/2024)<br>
...
Conducted research on design and implementation of the use case diagram for the use cases in the Maryville Grocery Delivery App:- (09/25/2024)<br>
...
Researched on Functional Requirements List (Iteration 2):- (09/25/2024)<br> 
Refined the functional requirements list based on client feedback. Updated system specifications using RFC 2119-compliant language. Organized requirements into mandatory (SHALL), recommended (SHOULD), and optional (MAY) categories. Added new requirements for system behavior and constraints.
...
Created Wiki Page for Non-Functional Requirements (Iteration 1):- (10/04/2024)<br>
...
Working on Non-Functional Requirements (Iteration 2):- (10/07/2024)<br>
...
Working on Data Management Plan (Iteration 1):- (10/09/2024)<br>
...
Researched on Data Management Plan :- (10/09/2024)<br>
...
Working on ER diagrams for the Data Management plan(Iteration 1) Document:- (10/09/2024)<br>
...
Working on Software Requirement Specification :- (11/11/2024)<br>
